...
public class Taxicab2MultiplyManuallyOn2SLOW {
	...
	public static void complexGetFirstAnswer() {
		...
		long delaySum=0;
		for(int i=0; i<inversePower5.length; i++) {
			delaySum = i * inversePower5[i] + 1 - i;
		}
		...
		for(int answerModM=0; answerModM<M; answerModM++) {
			System.out.println("Answer Mod M: " + answerModM);
	...
	public static void simpleGetFirstAnswer() {

...
public class ExtremeTanXCalculator {
	...
	public static boolean attemptTanXCheckUsePiApproxNoDoublePiOn2(Fraction piOn2ApproxToDeriveX, Fraction currentPrecisePiOn2, boolean tryingToBreak, int j) {
			...
			*/
			...
			//System.out.println("Attempt: " + X.toString());
			...
			try {
				...
				//TODO: maybe I have to write to file first
				process = new ProcessBuilder("C:\\Users\\Michael\\Desktop\\pfgw_win_4.0.1\\distribution\\pfgw64.exe","-q" + X.toString()).start();

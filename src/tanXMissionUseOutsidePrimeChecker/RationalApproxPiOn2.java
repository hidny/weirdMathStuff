...
class RationalApproxPiOn2 {
   ...
   public static void main(String[] args) {
      ...
      for(int i=0; left.getNumerator().toString().length() < 55*ONE_THOUSAND; i++) {
    	 ...
    	 /*
    	  ...
    	  if (tmp2.compareTo(tmp1) > 0) {
            ...
            for(int j=0; j<n2; j++) {
            	...
            	if(trial.getNumerator().equals(new BigInteger("1169809367327212570704813632106852886389036911"))) {
        			System.out.println("Debug");
        			
        		}
            	
            	
            	//TODO: figure out when to cut out wasteful trials...

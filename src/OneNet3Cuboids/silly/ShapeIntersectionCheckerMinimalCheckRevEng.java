...
public class ShapeIntersectionCheckerMinimalCheckRevEng implements SolutionResolverInterface {

	//Rev eng their 1080 for 7x1x1 and 3x1x1 (I only got 1070)
	// Maybe they over counted because they didn't account for 2 intersections for 1 shape?
	...
	private static int debugReverse1 = 0;
	private static int debugReverse2 = 0;
	...
	public long resolveSolution(CuboidToFoldOn cuboidDimensionsAndNeighbours, Coord2D paperToDevelop[], int[][] indexCuboidonPaper, boolean[][] OrigPaperUsed) {
		...
		if(debugNumIntersect > 1) {
			debugReverse1++;
			debugReverse2 += (debugNumIntersect - 1);
			System.out.println("Debug reverse eng (aiming for 10 (which is 1080-1070, which is their sol-my sol):");
			System.out.println("debugReverse1: " + debugReverse1);
			System.out.println("debugReverse1: " + debugReverse2);
